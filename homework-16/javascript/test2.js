...
if (confirm(`Почати   тестування?`)) {
    ...
    class TMoney {
        constructor(initialMoneyDollars, initialExchange) {
            this._moneyDollars = 0;
        ...
        set MoneyDollars(val) {
            if (val < 0)
                throw new Error('MoneyDollars is incorrect');
        ...
        set DollarExchangeRate(val) {
            if (val < 0)
                throw new Error('DollarExchangeRate is incorrect');
