...
if (confirm(`Почати   тестування?`)) {
    ...
    // клас фірма
    class Firm {
        constructor(companyName, registryNumber) {
            this.companyName = '';
    ...
    // клас товари
    class Product {
        constructor(productName, unitOfMeasurement, numberOfProduct, firmProduct) {
            this.productName = '';
